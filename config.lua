return {
    ...
    jobs = {
        ...
        },
        {
            ...
            pay = '$220',
            description = [[<strong>Police Officers</strong> maintain public order, enforce laws, and investigate crimes. 
        ...
        },
        {
            ...
            label = 'Paramedic',
            pay = '$200',
            description = [[<strong>Paramedics</strong> provide emergency medical care and transport for critically ill and injured patients. 
        ...
        },
        {
            ...
            label = 'Trucker',
            pay = '$190',
            description = [[<strong>Truckers</strong> transport goods over long distances, ensuring timely and safe delivery. 
        ...
        },
        {
            ...
            label = 'Mechanic',
            pay = '$175',
            description = [[<strong>Mechanics</strong> inspect, maintain, and repair vehicles and machinery. 
